...
const RidePopUp = (props) => {
    ...
    console.log(props.rideData," ride pop up");
    //const {destination,pickup,fare,user} = props.rideData;
    return (
        <div>
            ...
            <div className='flex items-center justify-between p-3 bg-yellow-400 rounded-lg mt-4'>
                <div className='flex items-center gap-3 '>
                    ...
                    <h2 className='text-lg font-medium'>{props.rideData?.user?.fullName?.fName + " " + props.rideData?.user?.fullName?.lName}</h2>
                </div>
            ...
            <div className='flex gap-2 justify-between flex-col items-center'>
                <div className='w-full mt-5'>
                    ...
                    <div className='flex items-center gap-5 p-3 border-b-2'>
                        ...
                        <div>
                            <h3 className='text-lg font-medium'>562/11-A</h3>
                            <p className='text-sm -mt-1 text-gray-600'>{props.rideData?.destination
                            }</p>
                        </div>
                    </div>

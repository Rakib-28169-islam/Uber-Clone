    ...
    return (
        <div>
            <h5 className='p-1 text-center w-[93%] absolute top-0' onClick={() => {
                props.setOpenConfirmRidePopup(false);
                props.setOpenRidePopup(true);
            ...
            <div className='flex items-center justify-between p-3 border-2 border-yellow-400 rounded-lg mt-4'>
                <div className='flex items-center gap-3 '>
                    ...
                    <h2 className='text-lg font-medium capitalize'>{'Alok Kapali'}</h2>
                </div>
            ...
            <div className='flex gap-2 justify-between flex-col items-center'>
                ...
                <div className='mt-6 w-full'>
                    <form onSubmit={(e)=>submitHandler(e)}>
                        ...
                        }} className='w-full mt-2 bg-red-600 text-center text-lg text-white font-semibold p-3 rounded-lg'>Cancel</div>

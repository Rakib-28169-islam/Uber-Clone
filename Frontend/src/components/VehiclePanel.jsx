...
const VehiclePanel = ({setOpenPanel,setOpenVehiclePanel,setOpenConfirmRidePanel}) => {
    ...
    return (
        <div>
            ...
            <div onClick={() => {
                ...
                <h2 className='text-lg font-semibold'><span className="font-bold text-3xl ">৳</span>{400}</h2>
            </div>
            <div onClick={() => {
                suggestionClickHandler()
                ...
                <h2 className='text-lg font-semibold'><span className="font-bold text-3xl ">৳</span>{200}</h2>
            </div>
            <div onClick={() => {
                suggestionClickHandler()
